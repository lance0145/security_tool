...
def whitesource_vuln_data(request):
    ...
    if request.method == "POST":
        ...
        total_high = len(all_whitesource_data.filter(severity='High')) + len(all_whitesource_data.filter(severity='Critical'))
        total_medium = len(all_whitesource_data.filter(severity='Medium'))
        total_low = len(all_whitesource_data.filter(severity='Minimal')) + len(all_whitesource_data.filter(severity='Very Minimal'))
